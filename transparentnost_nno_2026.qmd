...
#| warning: FALSE
#| message: FALSE
#| tbl-cap: "Základní charakteristiky vzorku dle organizace"
...
```{r tbl-web}
#| echo: FALSE
#| tbl-cap: "Tabulka absolutních četností: zv_kontinualni × web"
...
```{r tbl-ucetnictvi}
#| echo: FALSE
#| tbl-cap: "Tabulka absolutních četností: zv_kontinualni × typ účetnictví"
...
```{r tbl-kontakty}
#| echo: FALSE
#| tbl-cap: "Tabulka absolutních četností: zv_kontinualni × alespoň jeden kontakt"
...
```{r tbl-chisq-vysledky}
#| echo: FALSE
#| tbl-cap: "Výsledky &chi;&sup2; testů dobré shody na zv_kontinualni (&alpha; = 0,05)"
...
```{r tbl-wilcox-tabulka}
#| echo: FALSE
#| warning: FALSE
#| message: FALSE
#| tbl-cap: "Srovnání mediánů spojitých proměnných dle zv_kontinualni (v tis. Kč)"
...
```{r tbl-logit-tabulka}
#| echo: FALSE
#| tbl-cap: "Výsledky backward logistické regrese (AIC = 48,7)"
...
```{r fig-regrese-majetek}
#| echo: false
#| fig-cap: "Predikovaná pravděpodobnost zveřejnění účetní závěrky v závislosti na výši majetku (95% IS)."
...
p_pred_majetek <- ggplot(pred_majetek, aes(x = x, y = predicted)) +
  ...
  labs(
    ...
    caption = "Pozn.: Ostatní proměnné drženy na průměru/referenční kategorii."
  ) +
  theme_minimal()
...
ggplotly(p_pred_majetek, tooltip = c("x", "y"),
  ...
  layout(margin = list(b = 55),
         xaxis = list(title = list(text = "Majetek (tis. Kč)", standoff = 10)),
         annotations = 
           list(x = 1, y = -0.20, xref = "paper", yref = "paper", 
                xanchor = "right", showarrow = FALSE,
                text = "<i>Pozn.: Ostatní proměnné drženy na průměru/referenční kategorii.</i>",
                font = list(size = 11, color = "gray60")
                )
         ) |>
  config(
    displayModeBar = TRUE,
...
::: {style="display:flex; justify-content:center;"}
```{r fig-regrese-organizace}
#| echo: false
#| fig-cap: "Predikovaná pravděpodobnost zveřejnění účetní závěrky podle typu organizace (95% IS)."
...
ggplotly(p_pred_oganizace, tooltip = c("color", "y"), 
         height = 360, width = 650) |>
  layout(margin = list(b = 55),
         xaxis = list(title = list(text = "Organizace", standoff = 10)),
         annotations = 
           list(x = 1, y = -0.20, xref = "paper", yref = "paper", 
                xanchor = "right", showarrow = FALSE,
                text = "<i>Pozn.: Ostatní proměnné drženy na průměru/referenční kategorii.</i>",
